...
class Bot:
    def bot(self):
        # Sequence: Sequencia_glpi_regra_item_chamado2
        ...
        for item_regra in banco_regra:
            ...
            # Find Element Activity
            # Displayname: Find_Element
            elemento2 = webBot.find_element(selector="/html/body/span/span/span/input", by=By.XPATH, waiting_time=1000, ensure_visible=False, ensure_clickable=False)

            # Type Into Activity
            # Displayname: Dados_de_ip
            elemento2.send_keys("glpi")
