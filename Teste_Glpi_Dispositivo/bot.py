...
class Bot:
    def bot(self):
        # Sequence: Sequencia_glpi_dispositivo
        ...
        for item_dispositivo in banco_dispositivo:
            ...
            menu_porta_rede = webBot.find_element(selector="/html/body/div[2]/div[2]/div/main/div/div/div[2]/div[2]/ul/li[8]/a/span", by=By.XPATH, waiting_time=1000, ensure_visible=False, ensure_clickable=False)
